...
# ------------------------------------------------------------------------------------------------
#my $lockfile = File::Lockfile->new('rs.lock' , '/tmp');
...
my $dsn_dj = "DBI:mysql:database=pintimes;host=production-mysql.cone5c5tvg75.us-west-2.rds.amazonaws.com;mysql_connect_timeout=100";
